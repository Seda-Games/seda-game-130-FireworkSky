...
Shader "ccc/HalfLambert Ground Common Outside"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _LightColor0, _LightColor;
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                half3 finalColor = max(0, lerp(shadowColor, baseColor, diffVal) * lightColor * _LightColor);
